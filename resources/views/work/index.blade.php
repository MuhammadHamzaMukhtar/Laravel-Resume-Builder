            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-right" style="display:inline-block;float:right">
                        <a href="{{route('work_create')}}" class="btn btn-outline-success"><i class="fa-solid fa-plus"></i></a>
                    </div>
                    <hr>
                          ...
                          @endphp
                           @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->year}}</td>
                                <td>
                                    <a href="{{ url('work_update/'.$d->id) }}" class="btn btn-outline-primary btn-sm"><i class="fa fa-pen"></i></a>
                                    <a href="{{ url('work_delete/'.base64_encode($d->id)) }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure ?')"><i class="fa fa-trash"></i></a>
