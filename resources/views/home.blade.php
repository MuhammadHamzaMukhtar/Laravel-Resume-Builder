                ...
                <div class="card-body">
                    ...
                    <form action="{{route('store')}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" placeholder="Enter First Name" value="{{ Auth::user()->name }}">
                                    @error('first_name')
                        ...
                        <div class="form-group">
                            <div class="row ">
                                <div class="col-md-6">
                                    <a href="{{url('/')}}" class="btn btn-info text-white">Back</a>
